...
export class WeatherComponent {
  ...
  getWeather() {
    ...
    const apiKey = '900457ae1e9cc2a4b2c5434999b9aaaf'; // Chiave API per OpenWeather
    this.loading = true;
    this.errorMessage = '';
  ...
  getCitySuggestions(city: string) {
    return this.http.get<any>(`https://wft-geo-db.p.rapidapi.com/v1/geo/cities?namePrefix=${city}&limit=5`, {
      headers: {
        'X-RapidAPI-Key': 'fd21835cf0mshffe33f707fa2484p1c0fdcjsncf205ae525b5', // Chiave API per RapidAPI
